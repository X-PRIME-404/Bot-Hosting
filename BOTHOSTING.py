...
@app.route('/')
def home():
    return "I'am PREMIUM HOSTING BOT"
...
# --- Configuration ---
TOKEN = '8691694623:AAEURLVY93UYmMPaBLfVvT7Wqq9gkKBwAoY' # Replace with your actual token
OWNER_ID = 2021916390 # Replace with your Owner ID
ADMIN_ID = 2021916390 # Replace with your Admin ID (can be same as Owner)
YOUR_USERNAME = '@X_P4IM' # Replace with your Telegram username (without the @)
UPDATE_CHANNEL = 'https://t.me/X_PRIME_2' # Replace with your update channel link
